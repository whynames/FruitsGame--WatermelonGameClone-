#if BotanGameServices_NATIVE_GOOGLEPLAY
        ...
        internal RateGameData RateGameSettings
        {
            get
            {
                if (rateGameSettings == null)
                {
                    ...
                    if (rateGameSettings == null)
                    {
                        Debug.LogWarning("Rate Popup is not setup. Go to Tools->BotanGameServices->Rate Game to setup");
...
#if BotanGameServices_NATIVE_APPSTORE
