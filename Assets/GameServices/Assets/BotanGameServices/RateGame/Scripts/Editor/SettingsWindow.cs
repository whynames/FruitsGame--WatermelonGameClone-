...
using BotanGameServices.RateGame.Internal;
using UnityEditor;
...
namespace BotanGameServices.RateGame.Editor
{
    public class SettingsWindow : EditorWindow
    {
        ...
        private void SetPreprocessorDirectives()
        {
            ...
            if (useNativePopup)
            {
                PreprocessorDirective.AddToPlatform(SettingsWindowProperties.BotanGameServices_NATIVE_GOOGLEPLAY, false, BuildTargetGroup.Android);
                PreprocessorDirective.AddToPlatform(SettingsWindowProperties.BotanGameServices_NATIVE_APPSTORE, false, BuildTargetGroup.iOS);
            }
            else
            {
                PreprocessorDirective.AddToPlatform(SettingsWindowProperties.BotanGameServices_NATIVE_GOOGLEPLAY, true, BuildTargetGroup.Android);
                PreprocessorDirective.AddToPlatform(SettingsWindowProperties.BotanGameServices_NATIVE_APPSTORE, true, BuildTargetGroup.iOS);
            }
        }
    }
}
