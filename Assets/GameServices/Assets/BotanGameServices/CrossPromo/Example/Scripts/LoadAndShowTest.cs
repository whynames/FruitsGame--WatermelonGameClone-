...
namespace BotanGameServices.CrossPromo.Internal
{
    public class LoadAndShowTest : MonoBehaviour
    {
        private void Start()
        {
            ...
            BotanGameServices.CrossPromo.API.Initialize(InitializationComplete);
        }
        ...
        public void ShowPromo()
        {
            ...
            BotanGameServices.CrossPromo.API.ShowCrossPromoPopup(PopupClosed);
        }
        ...
        public void ForceShowPromo()
        {
            ...
            BotanGameServices.CrossPromo.API.ForceShowPopup(PopupClosed);
        }
