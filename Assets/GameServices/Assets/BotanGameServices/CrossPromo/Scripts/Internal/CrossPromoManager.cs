    ...
    public class CrossPromoManager : MonoBehaviour
    {
        ...
        public void Initialize(UnityAction<bool, string> CompleteMethod = null)
        {
            if (initialized == false)
            {
                ...
                {
                    Debug.LogWarning("BotanGameServices Cross Promo Plugin is not properly configured. Go to Tools->BotanGameServices->Cross Promo to set up the plugin. See the documentation");
                    return;
                }
