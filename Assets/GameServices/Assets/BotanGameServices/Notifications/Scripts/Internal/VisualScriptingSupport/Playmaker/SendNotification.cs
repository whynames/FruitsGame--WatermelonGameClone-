...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class SendNotification : FsmStateAction
    {
        ...
        {
            BotanGameServices.Notifications.API.SendNotification(gameTitle, notificationBody, new System.TimeSpan(hours, minutes, seconds), smallIcon, largeIcon, "Opened from Notification");
            Finish();
        }
    }
}
