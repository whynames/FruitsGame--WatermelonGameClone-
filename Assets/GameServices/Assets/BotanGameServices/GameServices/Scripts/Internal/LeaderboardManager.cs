...
#if BotanGameServices_GAMESERVICES_IOS
using UnityEngine.SocialPlatforms;
using UnityEngine.SocialPlatforms.GameCenter;
#endif
#if BotanGameServices_GAMESERVICES_ANDROID
...
namespace BotanGameServices.GameServices.Internal
{
    public class LeaderboardManager
    {
        ...
        public LeaderboardManager()
        {
            ...
            {
                Debug.LogError("Game Services Data not found -> Go to Tools->BotanGameServices->Game Services to setup the plugin");
            }
        }
