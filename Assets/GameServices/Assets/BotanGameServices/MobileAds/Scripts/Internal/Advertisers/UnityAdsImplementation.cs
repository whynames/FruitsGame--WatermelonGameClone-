#if BotanGameServices_UNITYADS
using UnityEngine.Events;
using UnityEngine;
using UnityEngine.Advertisements;
using BannerPosition = BotanGameServices.MobileAds.BannerPosition;
    ...
    public class UnityAdsImplementation : MonoBehaviour, IAdProvider, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
    {
        ...
        public void InitializeAds(PlatformSettings platformSettings, UnityAction onInitialized)
        {
            if (initialized == false)
            {
                ...
                BotanGameServicesLogger.AddLog($"{settings.idBanner.displayName} : {bannerPlacement}");
                BotanGameServicesLogger.AddLog($"{settings.idInterstitial.displayName} : {bannerPlacement}");
                BotanGameServicesLogger.AddLog($"{settings.idRewarded.displayName} : {rewardedVideoAdPlacement}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Unity Ads Initialization Failed: {error} - {message}");
        }
        #endregion
            ...
            if (IsBannerAvailable())
            {
                ...
                switch (position)
                {
                    ...
                    case BannerPosition.Center:
                        ...
                        break;
                    default:
                        BotanGameServicesLogger.AddLog($"Banner Position: {position} not supported by Unity Ads, BannerPosition.Top will be used");
                        break;
                }
                ...
                BotanGameServicesLogger.AddLog($"Start Loading Placement: {bannerPlacement}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner Load Success");
        ...
        {
            BotanGameServicesLogger.AddLog("Banner Clicked");
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner Load Failed {message}");
            HideBanner();
        ...
        {
            BotanGameServicesLogger.AddLog("Banner Displayed");
        }


        private void BannerHidded()
        {
            BotanGameServicesLogger.AddLog("Banner Hidden");
        }
        #endregion
        ...
        private void LoadInterstitialAd()
        {
            ...
            BotanGameServicesLogger.AddLog($"Loading Interstitial Ad: {videoAdPlacement}");
        ...
        private void LoadRewardedVideo()
        {
            ...
            BotanGameServicesLogger.AddLog($"Loading Rewarded Video Ad: {rewardedVideoAdPlacement}");
        ...
        public void OnUnityAdsAdLoaded(string placementId)
        {
            if (placementId == videoAdPlacement)
            {
                ...
                BotanGameServicesLogger.AddLog($"Interstitial Ad Loaded: {placementId}");
            ...
            if (placementId == rewardedVideoAdPlacement)
            {
                ...
                BotanGameServicesLogger.AddLog($"Rewarded Video Ad Loaded: {placementId}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Error loading Ad Unit: {placementId} - {error} - {message}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Error showing Ad Unit {placementId}: {error} - {message}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Ad Shown: {placementId}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Ad Clicked: {placementId}");
            if (placementId == videoAdPlacement)
            {
        ...
        {
            BotanGameServicesLogger.AddLog($"OnUnityAdsShowComplete {placementId}");
            if (placementId == videoAdPlacement)
            {
                BotanGameServicesLogger.AddLog($"Interstitial result: {showCompletionState}");
            ...
            if (placementId == rewardedVideoAdPlacement)
            {
                BotanGameServicesLogger.AddLog($"Complete method result: {showCompletionState}");
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowBuiltInConsentWindow Not supported on {SupportedAdvertisers.UnityLegacy}");
        }
        #endregion
        ...
        {
            BotanGameServicesLogger.AddLog($"OpenDebugWindow Not supported on {SupportedAdvertisers.UnityLegacy}");
        }
        #endregion
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowAppOpen Not supported on {SupportedAdvertisers.UnityLegacy}");
        }
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowRewardedInterstitial Not supported on {SupportedAdvertisers.UnityLegacy}");
        }
        #endregion
    }
}
