#if BotanGameServices_LEVELPLAY
    ...
    public class LevelPlayImplementation : MonoBehaviour, IAdProvider
    {
        ...
        public void InitializeAds(PlatformSettings platformSettings, UnityAction onInitialized)
        {
            if (initialized == false)
            {
                ...
                BotanGameServicesLogger.AddLog($"{settings.idBanner.displayName} : {bannerAdUnit}");
                BotanGameServicesLogger.AddLog($"{settings.idMRec.displayName} : {mrecAdUnit}");
                BotanGameServicesLogger.AddLog($"{settings.idInterstitial.displayName} : {interstitialAdUnit}");
                BotanGameServicesLogger.AddLog($"{settings.idRewarded.displayName} : {rewardedVideoAdUnit}");
        ...
        public void ShowBanner(string bannerID, BannerPosition position, BannerType bannerType, Vector2Int customSize, Vector2Int customPosition)
        {
            ...
            switch (bannerType)
            {
                ...
                case BannerType.Custom:
                    break;
                default:
                    BotanGameServicesLogger.AddLog($"Banner Type: {bannerType} not supported by IronSource, BannerType.Banner will be used");
                    break;
            ...
            switch (position)
            {
                ...
                case BannerPosition.Bottom:
                    ...
                    break;
                default:
                    BotanGameServicesLogger.AddLog($"Banner Position: {position} not supported by IronSource, BannerPosition.Top will be used");
                    break;
            }
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner Ad Loaded Event {adInfo}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner Ad Load Failed Event {error}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner Ad Clicked Event {adInfo.adNetwork}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner Ad Screen Presented Event {adInfo.adNetwork}");
        }

        //Notifies the presented screen has been dismissed
        void BannerAdScreenDismissedEvent(IronSourceAdInfo adInfo)
        {
            BotanGameServicesLogger.AddLog($"Banner Ad Screen Dismissed Event {adInfo.adNetwork}");
        }

        //Invoked when the user leaves the app
        void BannerAdLeftApplicationEvent(IronSourceAdInfo adInfo)
        {
            BotanGameServicesLogger.AddLog($"Banner Ad Left Application Event {adInfo.adNetwork}");
        }
        #endregion
        ...
        {
            BotanGameServicesLogger.AddLog(this + " Start Loading Interstitial");
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial Failed To Load {error}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial Show Success {adInfo.adNetwork}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial Failed To Show {error} {adInfo}");
            StartCoroutine(ReloadInterstitial(reloadTime));
        }
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial Ad Clicked Event {adInfo.adNetwork}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial Ad Ready Event {adInfo}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial Ad Opened Event {adInfo.adNetwork}");
        }
        ...
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Opened Event {adInfo.adNetwork}");
        }
        ...
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Closed Event {adInfo.adNetwork}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Rewarded Event {placement} {adInfo.adNetwork}");
        ...
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Show Failed Event {error} {adInfo}");
        }


        private void RewardedVideoAdClickedEvent(IronSourcePlacement placement, IronSourceAdInfo adInfo)
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Clicked Event {placement} {adInfo.adNetwork}");
            events.TriggerRewardedVideoClicked();
        }

        private void RewardedVideoAdUnavailableEvent()
        {
            BotanGameServicesLogger.AddLog("Rewarded Video Ad Unavailable Event");
        }

        private void RewardedVideoAdAvailableEvent(IronSourceAdInfo adInfo)
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Available Event {adInfo}");
        }


        private void RewardedVideoAdLoadFailedEvent(IronSourceError error)
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Load Failed Event {error}");
            events.TriggerRewardedVideoLoadFailed(error.ToString());
        }

        private void RewardedVideoAdReadyEvent(IronSourceAdInfo info)
        {
            BotanGameServicesLogger.AddLog($"Rewarded Video Ad Ready Event {info}");
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowBuiltInConsentWindow Not supported on {SupportedAdvertisers.LevelPlay}");
        }
        #endregion
        ...
        {
            BotanGameServicesLogger.AddLog($"OpenDebugWindow Not supported on {SupportedAdvertisers.LevelPlay}");
        }
        #endregion
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowAppOpen Not supported on {SupportedAdvertisers.LevelPlay}");
        }
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowRewardedInterstitial Not supported on {SupportedAdvertisers.LevelPlay}");
        }
        #endregion
    }
}
