#if BotanGameServices_APPLOVIN
using UnityEngine;
using UnityEngine.Events;

namespace BotanGameServices.MobileAds.Internal
{
    public class AppLovinImplementation : MonoBehaviour, IAdProvider
    {
        ...
        public void InitializeAds(PlatformSettings platformSettings, UnityAction onInitialized)
        {
            ...
            {
                events = new Events();
                if (BotanGameServicesLogger.IsInitialized())
                {
        ...
        private void ApplovinInitialized(MaxSdk.SdkConfiguration sdkConfiguration)
        {
            ...
            BotanGameServicesLogger.AddLog($"Initialization Successful: {sdkConfiguration.IsSuccessfullyInitialized}");
            ...
            {
                BotanGameServicesLogger.AddLog("ADD EVENTS");
        ...
        private void LoadBanner(BannerPosition position, BannerType bannerType, Vector2Int customPosition, Vector2Int customSize)
        {
            ...
            switch (position)
            {
                ...
                case BannerPosition.Custom:
                    break;
                default:
                    BotanGameServicesLogger.AddLog($"Banner Position: {position} not supported by AppLovin, BannerPosition.Top will be used");
                    break;
            }
            ...
            switch (bannerType)
            {
                ...
                case BannerType.Custom:
                    ...
                    break;
                default:
                    BotanGameServicesLogger.AddLog($"Banner Type: {bannerType} not supported by AppLovin, Default banner behavior will be used");
                    MaxSdk.SetBannerExtraParameter(bannerId, "adaptive_banner", "true");
                    break;
            }
        ...
        {
            BotanGameServicesLogger.AddLog("Banner ad loaded");
        ...
        {
            BotanGameServicesLogger.AddLog($"Banner ad failed to load {errorInfo.Code} {errorInfo.Message}");
        ...
        {
            BotanGameServicesLogger.AddLog("Banner ad clicked");
        ...
        {
            BotanGameServicesLogger.AddLog("Banner ad revenue paid");
        }
        #endregion
        ...
        private void LoadInterstitial()
        {
            ...
            {
                BotanGameServicesLogger.AddLog("Load Interstitial");
        ...
        {
            BotanGameServicesLogger.AddLog("Interstitial ad was loaded " + adInfo.NetworkName);
        ...
        {
            BotanGameServicesLogger.AddLog($"Interstitial ad failed to load {errorInfo.Code}");
            BotanGameServicesLogger.AddLog($"Reloading {retryNumberInterstitial} in {reloadInterval}  sec");
        ...
        {
            BotanGameServicesLogger.AddLog(this + " interstitial ad failed to display " + errorInfo.Code);
            LoadInterstitial();
        }
        ...
        private void OnInterstitialDismissedEvent(string arg1, MaxSdkBase.AdInfo arg2)
        {
            ...
            BotanGameServicesLogger.AddLog("Interstitial ad was closed");
        ...
        {
            BotanGameServicesLogger.AddLog($"OnInterstitialClickedEvent {info}");
            events.TriggerInterstitialClicked();
        }

        private void OnInterstitialRevenuePaidEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            BotanGameServicesLogger.AddLog($"OnInterstitialRevenuePaidEvent {adInfo}");
        }
        #endregion
        ...
        private void LoadAppOpen()
        {
            ...
            {
                BotanGameServicesLogger.AddLog("Load App Open");
                retryNumberAppOpen++;
        ...
        {
            BotanGameServicesLogger.AddLog("App Open ad was closed");
        ...
        {
            BotanGameServicesLogger.AddLog($"Open App ad failed to load {info}");
        ...
        {
            BotanGameServicesLogger.AddLog($"App Open revenue paid {info}");
        }

        private void OnAppOpenAdLoadedEvent(string arg1, MaxSdkBase.AdInfo info)
        {
            BotanGameServicesLogger.AddLog($"App Open ad was loaded {info}");
        ...
        {
            BotanGameServicesLogger.AddLog($" App Open ad failed to display {info1} {info2}");
            LoadAppOpen();
        }

        private void OnAppOpenAdDisplayedEvent(string arg1, MaxSdkBase.AdInfo info)
        {
            BotanGameServicesLogger.AddLog($"App Open ad was displayed {info}");
        }

        private void OnAppOpenAdClickedEvent(string arg1, MaxSdkBase.AdInfo info)
        {
            BotanGameServicesLogger.AddLog($"App Open ad was clicked {info}");
        ...
        private void LoadRewardedVideo()
        {
            ...
            {
                BotanGameServicesLogger.AddLog("Load Rewarded Video");
        ...
        {
            BotanGameServicesLogger.AddLog("Rewarded video was successfully loaded");
        ...
        private void OnRewardedAdFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
        {
            ...
            BotanGameServicesLogger.AddLog($"Rewarded video failed to load {errorInfo.Code} {errorInfo.Message}");

            BotanGameServicesLogger.AddLog($"Reloading {retryNumberRewarded} in {reloadInterval} sec");
        ...
        {
            BotanGameServicesLogger.AddLog($"Rewarded video failed to display {errorInfo.Code} {errorInfo.Message}");
        ...
        {
            BotanGameServicesLogger.AddLog("Rewarded video displayed");
        }


        private void OnRewardedAdClickedEvent(string arg1, MaxSdkBase.AdInfo arg2)
        {
            BotanGameServicesLogger.AddLog("Rewarded video clicked");
        ...
        {
            BotanGameServicesLogger.AddLog("Rewarded video was closed");
        ...
        {
            BotanGameServicesLogger.AddLog("Rewarded video was completed");
        ...
        private void OnRewardedAdRevenuePaidEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            ...
            BotanGameServicesLogger.AddLog($"Revenue {revenue} countryCode {countryCode} networkName {networkName} adUnitIdentifier {adUnitIdentifier} placement {placement}");
        ...
        {
            BotanGameServicesLogger.AddLog("Show MRec");
        ...
        private void LoadMRec(BannerPosition position, Vector2Int customPosition)
        {
            ...
            switch (position)
            {
                ...
                case BannerPosition.Custom:
                    break;
                default:
                    BotanGameServicesLogger.AddLog($"MRec Position: {position} not supported by AppLovin, AdViewPosition.Top will be used");
                    break;
            }
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowBuiltInConsentWindow Not supported on {SupportedAdvertisers.AppLovin}");
        }
        #endregion
        ...
        {
            BotanGameServicesLogger.AddLog($"ShowRewardedInterstitial Not supported on {SupportedAdvertisers.AppLovin}");
        }
        #endregion
    }
}
