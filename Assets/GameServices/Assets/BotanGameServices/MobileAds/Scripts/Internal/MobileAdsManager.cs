    ...
    public class MobileAdsManager : MonoBehaviour
    {
        ...
        public void Initialize(UnityAction completeMethod)
        {
            if (initialized == false)
            {
                ...
                if (adSettings == null)
                {
                    Debug.LogError("BotanGameServices Ads Plugin is not properly configured. Go to Tools->BotanGameServices->Mobile Ads to set up the plugin. See the documentation [LINK]");
                    return;
                }
                if (adSettings.debugMode)
                {
                    BotanGameServicesLogger.Initialize();
                }
...
#endif
                BotanGameServicesLogger.AddLog($"Selected advertiser: {selectedAdvertiser.advertiser}");
...
#if UNITY_ANDROID
            BotanGameServicesLogger.AddLog($"User GDPR consent is set to: {selectedAdvertiser.advertiserScript.GetGDPRConsent()}");
            BotanGameServicesLogger.AddLog($"User CCPA consent is set to: {selectedAdvertiser.advertiserScript.GetCCPAConsent()}");
#endif
        }
...
#endif
#if BotanGameServices_ADCOLONY && !UNITY_EDITOR
        ...
        public void ShowInterstitial(UnityAction InterstitialClosed)
        {
            ...
            {
                BotanGameServicesLogger.AddLog($"Interstitial from {selectedAdvertiser.advertiser} is available");
                selectedAdvertiser.advertiserScript.ShowInterstitial(InterstitialClosed);
            }
            else
            {
                BotanGameServicesLogger.AddLog($"Interstitial from {selectedAdvertiser.advertiser} is NOT available");
            }
        }
        ...
        public void ShowAppOpen(UnityAction appOpenClosed)
        {
            ...
            {
                BotanGameServicesLogger.AddLog($"App Open from {selectedAdvertiser.advertiser} is available");
                selectedAdvertiser.advertiserScript.ShowAppOpen(appOpenClosed);
            }
            else
            {
                BotanGameServicesLogger.AddLog($"App Open from {selectedAdvertiser.advertiser} is NOT available");
            }
        }
        ...
        public void ShowRewardedVideo(UnityAction<bool> CompleteMethod)
        {
            ...
            {
                BotanGameServicesLogger.AddLog($"Rewarded video from {selectedAdvertiser.advertiser} is available");
                selectedAdvertiser.advertiserScript.ShowRewardedVideo(CompleteMethod);
            }
            else
            {
                BotanGameServicesLogger.AddLog($"Rewarded video from {selectedAdvertiser.advertiser} is NOT available");
            }
        }
        ...
        public void ShowRewardedInterstitial(UnityAction<bool> CompleteMethod)
        {
            ...
            {
                BotanGameServicesLogger.AddLog($"Rewarded Interstitial from {selectedAdvertiser.advertiser} is available");
                selectedAdvertiser.advertiserScript.ShowRewardedInterstitial(CompleteMethod);
            }
            else
            {
                BotanGameServicesLogger.AddLog($"Rewarded Interstitial from {selectedAdvertiser.advertiser} is NOT available");
            }
        }
        ...
        public void ShowBanner(BannerPosition position, BannerType bannerType, Vector2Int customPosition, Vector2Int customSize)
        {
            ...
            BotanGameServicesLogger.AddLog($"Banner loaded from {selectedAdvertiser.advertiser}");
        ...
        public void HideBanner()
        {
            ...
            BotanGameServicesLogger.AddLog($"Hide banner {selectedAdvertiser.advertiser}");
        ...
        internal void ShowBuiltInConsentWindow(UnityAction consentPopupClosed)
        {
            ...
            BotanGameServicesLogger.AddLog("No built in consent popup found");
        }
