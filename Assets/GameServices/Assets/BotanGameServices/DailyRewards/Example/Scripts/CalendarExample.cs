...
namespace BotanGameServices.DailyRewards.Internal
{
    public class CalendarExample : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            BotanGameServices.DailyRewards.API.Calendar.AddClickListener(CalendarButtonClicked);
            BotanGameServices.DailyRewards.API.Calendar.SetValueFormatter(FormatValue);
        }
        ...
        public void ShowCalendar()
        {
            ...
            BotanGameServices.DailyRewards.API.Calendar.Show();
        }

        public void ResetCalendar()
        {
            BotanGameServices.DailyRewards.API.Calendar.Reset();
        }
    }
}