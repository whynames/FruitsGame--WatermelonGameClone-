...
using BotanGameServices.DailyRewards.API;
using System;
...
namespace BotanGameServices.DailyRewards.Internal
{
    ...
    public static class DailyRewardsUVS
    {
        ...
        private static void RewardButtonClicked(ButtonIdsForTimers buttonID, bool timeExpired)
        {
            CustomEvent.Trigger(timerButtonClickedTarget, "TimerButtonClicked", buttonID, timeExpired);
        }

        public static TimeSpan GetRemainingTime(ButtonIdsForTimers buttonID)
        {
