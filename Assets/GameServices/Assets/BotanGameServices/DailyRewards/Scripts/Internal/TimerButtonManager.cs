...
namespace BotanGameServices.DailyRewards.Internal
{
    ...
    {
        private UnityAction<ButtonIdsForTimers, bool> ClickListener;
        ...
        public void ResetTimer(ButtonIdsForTimers buttonID)
        {
        ...
        internal void ModifyTime(ButtonIdsForTimers buttonID, TimeSpan timeToAdd, bool remove)
        {
        ...
        public void Initialize(ButtonIdsForTimers buttonID, UnityAction<string, bool, string> InitializeComplete)
        {
            ...
            {
                Debug.LogWarning("Daily Rewards is not setup. Go to Tools->BotanGameServices->Daily Rewards to setup");
            }
            else
            {
                ...
                {
                    Debug.LogWarning(buttonID.ToString() + " not found. Go to Window->BotanGameServices->Daily Rewards and setup a button with " + buttonID.ToString() + " ID");
                }
            }
        }
        ...
        /// <returns></returns>
        TimerProperties GetTimer(ButtonIdsForTimers buttonID)
        {
        ...
        /// <param name="buttonID"></param>
        /// <returns></returns>
        DateTime GetSavedTime(ButtonIdsForTimers buttonID)
        {
        ...
        /// <param name="buttonID"></param>
        /// <returns></returns>
        TimeSpan GetTimeToPass(ButtonIdsForTimers buttonID)
        {
        ...
        /// <param name="buttonID"></param>
        /// <returns></returns>
        public TimeSpan GetRemainingTimeSpan(ButtonIdsForTimers buttonID)
        {
        ...
        /// <param name="buttonID"></param>
        /// <returns></returns>
        public string GetRemainingTime(ButtonIdsForTimers buttonID)
        {
        ...
        public void AddClickListener(UnityAction<ButtonIdsForTimers, bool> ClickListener)
        {
        ...
        public void ButtonClicked(ButtonIdsForTimers buttonID, UnityAction<bool> ClickResult)
        {
        ...
        /// <param name="buttonID"></param>
        /// <returns></returns>
        public bool TimeExpired(ButtonIdsForTimers buttonID)
        {
            TimeSpan difference = TimeMethods.SubtractTime(GetSavedTime(buttonID));
