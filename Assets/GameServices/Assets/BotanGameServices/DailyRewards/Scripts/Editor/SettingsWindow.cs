...
namespace BotanGameServices.DailyRewards.Editor
{
    public class SettingsWindow : EditorWindow
    {
        ...
        {
            PreprocessorDirective.AddToCurrent(SettingsWindowProperties.BotanGameServices_DAILY_REWARDS, false);
            if (usePlaymaker)
            {
                PreprocessorDirective.AddToCurrent(Main.Constants.BOTANGAMESERVICES_PLAYMAKER_SUPPORT, false);
            }
            else
            {
                PreprocessorDirective.AddToCurrent(Main.Constants.BOTANGAMESERVICES_PLAYMAKER_SUPPORT, true);
            }

            if (useUVS)
            {
                PreprocessorDirective.AddToCurrent(Main.Constants.BOTANGAMESERVICES_UVS_SUPPORT, false);
            }
            else
            {
                PreprocessorDirective.AddToCurrent(Main.Constants.BOTANGAMESERVICES_UVS_SUPPORT, true);
            }
        }
    }
}